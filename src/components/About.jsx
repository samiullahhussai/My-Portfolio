...
function About() {
  ...
  return (
    <div className="md:flex md:justify-center text-center bg-blue-50 shadow-2xl mx-4 md:mx-32 rounded-lg dark:bg-black dark:text-white dark:border dark:border-white " data-aos="fade-up">
